...
public partial class EditFU : System.Web.UI.Page
{
    ...
    {
        if (!string.IsNullOrEmpty(Convert.ToString(PatientIE_Id)) && File.Exists(Server.MapPath(Convert.ToString("~/Userimages/" + PatientIE_Id + ".jpeg"))))
        {
            ProfileImage.ImageUrl = Convert.ToString("~/Userimages/" + PatientIE_Id + ".jpeg");
        }
        else
        {
