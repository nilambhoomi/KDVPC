...
<%--    <h1 style="text-align: center">Patient FU Details</h1>--%>
    ...
    <table>
            <tr>
	               ...
	               <td><asp:TextBox ID="PatientIntime" TabIndex="28"  runat="server" ></asp:TextBox>
	                    <button type="button" class="btn btn-primary btn-small" onclick="getInTime()">Time In</button>
	               </td>
	               <td>Patient Out Time: </td>
	               <td> <asp:TextBox ID="PatientOuttime" TabIndex="29"  runat="server" ></asp:TextBox>
        ...
        <tr>
            ...
            <td> Family History</td>
                                      <td>    <asp:TextBox ID="FamilyHistory" runat="server"></asp:TextBox></td>
        </tr>
         <tr>
    ...
    <table>
        <tr>
              <td><strong>Body Parts Affected:   </strong>
                <br />
        ...
        </tr>       <tr>  <td style="padding-left: 30px"><strong class="pull-left">Notes: </strong><asp:TextBox runat="server" Style="float: left;" ID="txtFreeForm" TextMode="MultiLine" Width="500px" Height="100px"></asp:TextBox>
                        <button type="button" id="start_button" onclick="startButton(event)"><img height="25px" width="25px" src="images/mic.png" alt="start" /></button>  
                        <div style="display:none"> <span class="final" id="final_span"></span><span class="interim" id="interim_span"></span></div></td></tr>
         <tr>
            <td></td>
            <br />
            <td style="padding-left: 30px">
    ...
    <div style="display: none">
        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="Save" OnClick="btnSave_Click" /></div>
