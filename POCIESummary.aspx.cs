...
public partial class POCIESummary : System.Web.UI.Page
{
 ...
 CASE 
            ...
            {
                SqlStr += "WHERE PatientIE_ID = " + Session["PatientIE_ID"].ToString() + "-- and IsConsidered=0 and p.Executed is not null Order By BodyPart,Heading";
            }
            else if (ddlInhouse.SelectedValue.Equals("1"))
            {
                SqlStr += "WHERE PatientIE_ID = " + Session["PatientIE_ID"].ToString() + "  and IsConsidered=0 and p.Executed is not null and pp.INhouseProcbit = 1  Order By BodyPart,Heading ";
            }
            else if (ddlInhouse.SelectedValue.Equals("0"))
            {
                SqlStr += "WHERE PatientIE_ID = " + Session["PatientIE_ID"].ToString() + "  and IsConsidered=0 and p.Executed is not null and pp.INhouseProcbit = 0  Order By BodyPart,Heading";
            }
            else if (ddlInhouse.SelectedValue.Equals("2"))
            {
                SqlStr += "WHERE PatientIE_ID = " + Session["PatientIE_ID"].ToString() + "  and IsConsidered=0 and p.Executed is not null pp.Other = 1  Order By BodyPart,Heading";
            }
