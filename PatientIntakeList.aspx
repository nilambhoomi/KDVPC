        ...
        <div class="page-content">
            ...
            <div class="">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="gvPatientDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" DataKeyNames="PatientIE_ID" OnRowDataBound="OnRowDataBound" AllowPaging="True" OnPageIndexChanging="gvPatientDetails_PageIndexChanging1" PagerStyle-CssClass="pager">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
              ...
              <asp:HyperLink runat="server" CssClass="btn btn-link" ID="hlAddFU" NavigateUrl='<%# "~/AddFU.aspx?PID="+Eval("PatientIE_ID") %>' Text="AddFU"></asp:HyperLink>
						...
						<asp:HyperLink runat="server" CssClass="btn btn-link" ID="HyperLink5" NavigateUrl='<%# "~/Appointment.aspx?PID="+Eval("PatientId") %>' Text="| Appointment "></asp:HyperLink>
                                                   <asp:LinkButton runat="server" ID="lnkDelete" OnClientClick="return confirm('Are you sure you want to delete this IE ?')" CssClass="btn btn-link" CommandArgument='<%# Eval("PatientIE_ID").ToString()%>' OnClick="lnkDelete_Click">| Delete</asp:LinkButton>
                                                    <asp:Label ID="ClaimNumber" Text='<%#Eval("ClaimNumber") %>' runat="server" Style="display:none"></asp:Label>
                                                    <asp:Label ID="InsCo_ID" Text='<%#Eval("InsCo_ID") %>' runat="server" Style="display:none"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <RowStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                ...
                <div class="modal fade" id="ModalSign" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                 ...
                 <button type="button" class="close" style="float: right" data-dismiss="modal" aria-hidden="true">&times;</button>
                            ...
                            <div class="modal-body" style="width: 100%!important">
                                ...
                                <div id="signature-pad" class="signature-pad">
                                    <canvas runat="server" id="can"></canvas>

                                </div>
                                <div class="signature-pad--actions" id="action">
                                    <div>
