                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger">
                                                ...
                                                <label runat="server" id="lblmess" style="color: red; display: none">Sorry , Invalid Client Id.</label>
                                            </h4>
                                            <div class="space-6"></div>
                                            <fieldset>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <asp:TextBox runat="server" ID="txt_pass" TextMode="Password" placeholder="Password" class="form-control"></asp:TextBox>
                                                ...
                                                <label class="block clearfix">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="txtUserMasterID" ErrorMessage="Please Enter User Id" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </label>
                                                <div class="space"></div>
                                                <div class="clearfix">
