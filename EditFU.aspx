...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">  
   ...
   <script type="text/javascript">
    ...
    <table>
        ...
        <tr>  <td style="padding-left: 30px"><strong class="pull-left">Notes: </strong><asp:TextBox runat="server" Style="float: left;" ID="txtFreeForm" TextMode="MultiLine" Width="500px" Height="100px"></asp:TextBox>
                        <button type="button" id="start_button" onclick="startButton(event)"><img height="35px" width="35px"  src="images/mic.png" alt="start" /></button>  
