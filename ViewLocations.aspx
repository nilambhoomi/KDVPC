                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server" CssClass="btn btn-link" ID="hlEdit" Target="_blank" NavigateUrl='<%# "~/AddLocations.aspx?id="+Eval("Location_ID") %>' Text="Edit"></asp:HyperLink>
                                                 <asp:LinkButton runat="server" ID="lnkDelete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?')" CausesValidation="false" OnClick="lnkDelete_Click" Visible='<%# Eval("Is_Active").ToString().ToLower()=="true"?true:false %>' CommandArgument='<%# Eval("Location_ID") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
