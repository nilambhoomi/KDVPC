                         ...
                         <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlmcodetype" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Text="sx crt" Value="4"></asp:ListItem>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvProcedureTbl" AllowSorting="true" OnSorting="gridView_Sorting" runat="server" AutoGenerateColumns="false" PageSize="100" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" PagerStyle-CssClass="pager">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Requested" DataField="Requested" SortExpression="Requested" />
                                <asp:BoundField HeaderText="Schedule" DataField="Scheduled" SortExpression="Scheduled" />
                                <asp:BoundField HeaderText="Executed" DataField="Executed" SortExpression="Executed" />
                        ...
                        <asp:TextBox ID="txtQuery" runat="server" Style="display:none" ></asp:TextBox>
                    </div>
