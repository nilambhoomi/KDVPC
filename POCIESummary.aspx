<%@ Page Language="C#" MasterPageFile="~/PageMainMaster.master" AutoEventWireup="true" CodeFile="POCIESummary.aspx.cs" Inherits="POCIESummary" %>
                    ...
                    <asp:Repeater runat="server" ID="repSummery">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# Convert.ToBoolean(Convert.ToInt32(Eval("Other")))?"True":"False" %></td>
                            </tr>
                        </ItemTemplate>
