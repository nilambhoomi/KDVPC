...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="Server">--%>
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" align="center" Style="display: none">
        <div style="height: 60px">
            ...
            <%-- <ContentTemplate>--%>
                Details already exists.Do you want to proceed anyway?&nbsp;
        <table>
            <tr>
                <td></td>
    ...
    <asp:HiddenField ID="existHDN" runat="server" />
        ...
        <ContentTemplate>
            ...
            <div class="form-horizontal">
                ...
                <div class="control-group span3">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="txtMailing_address" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
            ...
            <div style="clear: both"></div>
            <asp:UpdatePanel runat="server" ID="pnlprovider">
                <ContentTemplate>
                    <div class="form-horizontal">
                        <div class="control-group span3">
            ...
            <div class="form-horizontal">
                <div class="control-group span12">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="txtNote" runat="server" TextMode="MultiLine" Width="700px" Height="100px"></asp:TextBox>
                    </div>
                </div>
