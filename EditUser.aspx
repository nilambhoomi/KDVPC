...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="Server">
    ...
    <br />
                                        <asp:CheckBoxList runat="server" ID="chkPages" RepeatDirection="Horizontal" CssClass="chkPage" RepeatColumns="4">
                                            ...
                                            <asp:ListItem Text="Delete Patients" Value="11"></asp:ListItem>
                                        </asp:CheckBoxList>
                                    </div>
                           ...
                           <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-sm-2">
                                       <%-- <label class="lblstyle">Reports</label>--%>
                                          <label class="lblstyle">BS</label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="checkbox" id="checkAllReportsBS" />
                                        Select All
    <br />
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <label class="lblstyle">Forms</label>
                                    </div>
                                     <div class="col-sm-8">
                                        <input type="checkbox" id="checkAllReportsForms" />
                                        Select All
    <br />
                                        
                                        
                                   
                                        <asp:CheckBoxList runat="server" ID="chkReportsForms" RepeatDirection="Horizontal" CssClass="chkReportsF" RepeatColumns="4"></asp:CheckBoxList>
                                    </div>
                                     </div>
                                 <br />
                                 <div class="row">
                                    <div class="col-sm-2">
                                        <label class="lblstyle">Letter</label>
                                    </div>
                                     <div class="col-sm-8">
                                        <input type="checkbox" id="checkAllReportsLetter" />
                                        Select All
    <br />
                                        
                                        
                                   
                                        <asp:CheckBoxList runat="server" ID="chkReportsLetter" RepeatDirection="Horizontal" CssClass="chkReportsL" RepeatColumns="3"></asp:CheckBoxList>
                                    ...
                                    <br />
                                     <div class="row">
                                    <div class="col-sm-2">
                                        <label class="lblstyle">Download</label>
                                    </div>
                                     <div class="col-sm-8">
                                        <input type="checkbox" id="checkAllReportsDownload" />
                                        Select All
    <br />
                                        
                                        
                                   
                                        <asp:CheckBoxList runat="server" ID="chkReportsDownload" RepeatDirection="Horizontal" CssClass="chkReportsDL" RepeatColumns="3"></asp:CheckBoxList>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#checkAllPage').click(function () {
             ...
             $('#checkAllReportsBS').click(function () {
                $('.chkReport input:checkbox').prop('checked', this.checked);
            });
            $('#checkAllReportsForms').click(function () {
                $('.chkReportsF input:checkbox').prop('checked', this.checked);
            });
            $('#checkAllReportsLetter').click(function () {
                $('.chkReportsL input:checkbox').prop('checked', this.checked);
            });
            $('#checkAllReportsDownload').click(function () {
                $('.chkReportsDL input:checkbox').prop('checked', this.checked);
            });
