...
public partial class AddPatientMaster : System.Web.UI.Page
{
    ...
    private void bindData()
    {
        ...
        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_Test_Live"].ConnectionString))
        {
            try
            {
                ...
                if (totalrecords > 0)
                {
                    ...
                    txtPolicyNo.Text = lds.Tables[0].Rows[0]["policy_no"].ToString();
    ...
    protected void BindPatientIEDetails(string patientId = null, string searchText = null)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("nusp_GetPatientIEDetails_1", con);
