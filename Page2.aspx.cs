        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            else
            {
                if (ds.Tables[0].Rows[0]["LossOfConsciousnessFor"].ToString() != "|")
                {
                    ...
                    ddl_howlong.ClearSelection();
                    string[] strLOC = ds.Tables[0].Rows[0]["LossOfConsciousnessFor"].ToString().Split('|');
                    if (strLOC.Length > 1)
                    {
                    ...
                    {
                        if (!string.IsNullOrEmpty(strLOC[0]))
                            ddl_howlong.Items.FindByText(ds.Tables[0].Rows[0]["LossOfConsciousnessFor"].ToString().Split('|')[0]).Selected = true;
